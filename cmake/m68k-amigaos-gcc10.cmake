...
if (NOT TOOLCHAIN_SYSTEM_NAME)
    string(TOLOWER ${CMAKE_SYSTEM_NAME} SYS_NAME)
    set(TOOLCHAIN_SYSTEM_NAME ${SYS_NAME})
endif()
set(TOOLCHAIN_PREFIX_DEFAULT "${SYS_CPU}-${TOOLCHAIN_SYSTEM_NAME}")
set(TOOLCHAIN_PREFIX ${TOOLCHAIN_PREFIX_DEFAULT} CACHE STRING "Compiler prefix, default: ${TOOLCHAIN_PREFIX_DEFAULT}")
if (NOT TOOLCHAIN_PREFIX_DIR)
    set(TOOLCHAIN_PREFIX_DIR ${TOOLCHAIN_PREFIX})
endif()
...
set(TOOLCHAIN_PATH_DEFAULT /opt/${TOOLCHAIN_PREFIX_DIR})
